...
export default function Filter() {
  ...
  function createHandleMenuClick(e) {
  ...
  return (
    <div className="items-center sm:flex">
      <Tabs value={sortBy} onChange={(e) => createHandleMenuClick(e)}>
        <TabsList>
          <Tab label="All" {...a11yProps("all")}>
            All
          </Tab>
          <Tab label="Discounts" {...a11yProps("discounts")}>
            Discounts
          </Tab>
          <Tab label="No Discounts" {...a11yProps("no-discounts")}>
            No Discounts
          </Tab>
        </TabsList>
