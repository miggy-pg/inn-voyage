        ...
        <div className="w-full mb-1">
          <div className="mb-4">
            <nav className="flex mb-5 ml-4" aria-label="Breadcrumb">
              <ol className="inline-flex items-center space-x-1 text-md font-medium md:space-x-2 lg:space-x-4">
                <li className="inline-flex items-center">
                  <span className="inline-flex items-center align-middle text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                    <svg
            ...
            <h1 className="text-lg font-semibold text-gray-900 sm:text-2xl dark:text-white lg:text-3xl ml-4">
              All products
            </h1>
          </div>
          <div className="items-center justify-between block sm:flex mb-5 md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div className="flex items-center mb-4 sm:mb-0">
              <form className="sm:pr-3" action="#" method="GET">
                <label htmlFor="products-search" className="sr-only">
                  Search
                </label>
                <div className="relative w-48 mt-1 sm:w-64 xl:w-[30rem]">
                  <input
                    type="text"
                    name="email"
                    id="products-search"
                    className="bg-gray-50 border ml-4 lg:text-2xl border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <button
              className="text-red bg-slate-200 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg lg:text-2xl sm:text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              type="button"
            >
              Add new product
            </button>
