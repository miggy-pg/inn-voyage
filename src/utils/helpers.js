...
// We want to make this function work for both Date objects and string (which come from Supabase)
...
// on every render because the MS or SEC have changed, which isn't good. So we use this
// trick to remove any time
